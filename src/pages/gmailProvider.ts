...
export class GmailProvider {
    ...
    async g_password_field( password : string ): Promise<void> {
        try {
            ...
            // The password screen never rendered — capture what Google DID serve.
            // This is how the Cloud Run captcha was finally identified: the timeout
            // blamed the password field, but the page was still /signin/identifier
            // showing "Type the text you hear or see".
            await logUnexpectedPage(this.page, 'ADOBE_GOOGLE_UNEXPECTED_PAGE');
            throw e;
        }
        await this.page.waitForTimeout(1000);
