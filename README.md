...
| **8** | `Setup Canvas` | [`createTemplate()`](file:///c:/Users/QA/WebstormProjects/Adobe_V2/src/pages/adobe.ts) | `AdobePage` | Click "Create new" → "Square" template, then wait for the editor template search to become ready |
